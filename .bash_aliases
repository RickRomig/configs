...
alias devglow='glow ~/.local/share/doc/devnotes.md'	# View developer notes
alias devnotes="$EDITOR $HOME/.local/share/doc/devnotes.md"	# Edit developer notes
alias df='df -h -x tmpfs -x fuse.portal' # ignore tmpfs and fuse.portal
alias dirs="dirs -v"
alias dos2linux-c="find . -maxdepth 1 -type f \( -name "*.c*" -or -name "*.h" \) -exec sed -i.bak 's/\r//g' '{}' \;"
...
alias restore-bg='~/.config/i3/backgrounds.sh'
